// keccak_round_c.v - one combinational Keccak-f[1600] round, iota constant
// baked in as a parameter so each unrolled pipeline stage gets its RC folded
// into LUTs. Equations identical to the chain-proven ZTEX keccak_round.v.
// State: 25 lanes of 64 bits, lane index = x + 5*y, st[64*i +: 64] = lane i.

module keccak_round_c #(
    parameter [63:0] RC = 64'h0
) (
    input  [1599:0] st_in,
    ...
    // rotated left by r[x][y]. Constant slices = pure wiring.
    wire [63:0] b [0:24];
    genvar x, y;
